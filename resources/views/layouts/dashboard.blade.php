        ...
        <header class="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-20">
            <div class="flex items-center justify-between px-6 py-4">
                ...
                <div class="flex items-center space-x-4">
                    <!-- Notifications -->
                    <div class="relative" x-data="{ open: false, unreadCount: 0, notifications: [], loading: true }" 
                         x-init="
                             ...
                             window.Echo.private('App.Models.User.' + {{ Auth::id() }})
                                 .notification((notification) => {
                                     ...
                                     notifications.unshift({
                                         ...
                                         time: 'à l\'instant',
                                         icon: notification.type === 'nouvelle_demande' ? 'fa-file-alt' : 
                                               (notification.type === 'paiement_effectue' ? 'fa-credit-card' : 'fa-bell'),
                                        ...
                                        <div class="flex items-start">
                                            <div class="flex-shrink-0 pt-1">
                                                <div class="h-8 w-8 rounded-full bg-gray-100 flex items-center justify-center" 
                                                     :class="{'bg-blue-50': notification.type === 'nouvelle_demande', 'bg-green-50': notification.type === 'paiement_effectue'}">
                                                    <i class="fas" :class="[notification.icon, notification.type === 'nouvelle_demande' ? 'text-blue-500' : (notification.type === 'paiement_effectue' ? 'text-green-500' : 'text-gray-400')]"></i>
                                                </div>
                                            </div>
